...
btn.addEventListener("click", function () {
    ...
    whatIDo.innerText = ""
    whatIDo.innerText += "Пытался здесь же вывести весь код соответствующей задачи, но, к сожалению, в процессе стал сильно пьян :( Будет реализовано позднее, пока следует смотреть script.js. В частности, не сработал перенос строки (эр-эн)"
})
...
btn3.addEventListener("click", function () {
    ...
    whatIDo.innerText = ""
    whatIDo.innerText += "Всех сгенерированных персонажей можно увидеть в консоли. Пытался здесь же вывести весь код соответствующей задачи, но, к сожалению, в процессе стал сильно пьян :( Будет реализовано позднее, пока следует смотреть script.js. В частности, не сработал перенос строки (эр-эн)"
})
